...
def request_sanitized_number(prompt: str) -> float:
    """
    Request and sanitize user input for viable form
...
def request_sanitized_operation(prompt: str) -> str:
    ...
    Returns:
        float: The sanitized operation by the user.
    """
    while True:
        ...
        if operation in ['add', 'subtract', 'multiply', 'divide']:
            ...
            print("Invalid input. Please enter a valid operation: add, subtract, multiply, or divide.")
